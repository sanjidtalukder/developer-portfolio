...
function App() {
  ...
  useEffect(() => {
    ...
    const updatePointerVars = () => {
      ...
      rafId = window.requestAnimationFrame(updatePointerVars);
    };

    const handlePointerMove = (event) => {
      const normalizedX = event.clientX / window.innerWidth - 0.5;
      const normalizedY = event.clientY / window.innerHeight - 0.5;
      state.targetX = normalizedX * 2;
      state.targetY = normalizedY * 2;
    };
  ...
  return (
    <>
      <div className="site-bg" aria-hidden="true">
        ...
        <span className="bg-orb orb-cyan" />
        <span className="bg-orb orb-violet" />
        <span className="bg-orb orb-pink" />
      </div>
      <div className="site-content">
        ...
        {/* Hero Section */}
        <section className="hero pt-24 pb-32">
          <div className="container">
            <div className="hero-content">
              ...
              <div className="hero-social">
                ...
                <a
                  href="https://www.linkedin.com/in/md-sanjid-talukder?utm_source=share_via&utm_content=profile&utm_medium=member_android"
                  target="_blank"
                  rel="noreferrer"
                  aria-label="LinkedIn"
                  className="social-link"
            ...
            <div className="about-content">
              <div className="about-text">
                ...
                <p>
                  ...
                  pixel-perfect, performant experiences. I have been fortunate
                  to work on various projects that have allowed me to hone my
        ...
        <section id="projects" className="section">
          <div className="container">
            ...
            <p className="section-subtitle">Live projects currently deployed</p>
            <div className="projects-grid">
              <div className="project-card">
                <div className="project-image">🌙</div>
                <div className="project-content">
                  <h3 className="project-title">Moonlit Project</h3>
                  <p className="project-description">
                    Modern live web project hosted on Netlify with responsive UI
                  ...
                  <div className="project-links">
                    <a
                      href="https://moonlit-lebkuchen-4ec955.netlify.app/"
                      target="_blank"
                      rel="noreferrer"
              ...
              <div className="project-card">
                <div className="project-image">✨</div>
                <div className="project-content">
                  <h3 className="project-title">Luminous Project</h3>
                  <p className="project-description">
                    Clean and visually polished live website deployed on
                    Netlify, focused on user-friendly content presentation.
                  </p>
                  <div className="project-tech">
                    <span>Live</span>
                    <span>Netlify</span>
                  ...
                  <div className="project-links">
                    <a
                      href="https://luminous-mandazi-e5f26e.netlify.app/"
                      target="_blank"
                      rel="noreferrer"
                      className="project-link"
                    >
              ...
              <div className="project-card">
                <div className="project-image">⭐</div>
                <div className="project-content">
                  <h3 className="project-title">Starlit Project</h3>
                  <p className="project-description">
                    Feature-rich live website published on Netlify with modern
                    layout, smooth navigation, and responsive structure.
                  </p>
                  <div className="project-tech">
                    <span>Live</span>
                    <span>Netlify</span>
                  ...
                  <div className="project-links">
                    <a
                      href="https://starlit-churros-684484.netlify.app/"
                      target="_blank"
                      rel="noreferrer"
                      className="project-link"
                    >
          ...
          <div className="container">
            ...
            <div className="contact-content">
              <p className="contact-text">
                ...
                question, a project proposal, or just want to say hi, I'll try
